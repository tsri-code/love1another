...
export const PRAYER_VERSES: Verse[] = [
  {
    id: 1,
  ...
  },
  {
    ...
    text: "Again, truly I tell you that if two of you on earth agree about anything they ask for, it will be done for them by my Father in heaven. For where two or three gather in my name, there am I with them."
  },
  {
    id: 12,
  ...
  {
    id: 27,
    reference: "Psalm 86:6-7",
    text: "Hear my prayer, Lord; listen to my cry for mercy. When I am in distress, I call to you, because you answer me."
  },
  {
    id: 28,
    reference: "John 14:13-14",
    text: "And I will do whatever you ask in my name, so that the Father may be glorified in the Son. You may ask me for anything in my name, and I will do it."
  },
  {
    id: 29,
    reference: "Psalm 4:1",
  ...
  },
  {
    id: 31,
    reference: "Job 22:27",
    text: "You will pray to him, and he will hear you, and you will fulfill your vows."
  },
  {
    id: 32,
  ...
  },
  {
    ...
    text: "They will call on my name and I will answer them; I will say, 'They are my people,' and they will say, 'The Lord is our God.'"
  }
];
